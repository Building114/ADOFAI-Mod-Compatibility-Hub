# Notice for TimingShow XDBuilding
...
- Building114 is not the original author of TimingShow.
- Building114 maintains only this temporary compatibility patch.
- The original TimingShow name is used only to identify what this patch is based on.
- Users should prefer an official TimingShow update if one becomes available.

If the original author or another rights holder wants this patch corrected, renamed, or removed, please contact Building114 through GitHub.
